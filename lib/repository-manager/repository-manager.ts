...
import { RepositoryMixinDefinition } from './interfaces';
import { MixinRepository } from './mixin-repository';
import { REPOSITORY_ENTITY } from './repository.decorator';
...
export class RepositoryManager {
	...
	private readonly logger = new ColorizedLogger('RepositoryManager',{},'magenta');
